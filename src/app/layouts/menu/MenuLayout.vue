<template>
 <div>
   <!--side bar-->
   <div class="w-full px-6 pt-3 pb-10 hidden md:flex">
     <!--Logo-->
     <div>
   ...
   <!--menu-->
   <div class="md:h-[calc(90vh-50px)] w-full relative md:px-4 md:mt-8 flex items-center md:flex-col justify-between">
     <div class="w-full">
     ...
     <div class="w-full">
       <div v-for="link in others" :key="link.label" class="flex md:flex-col ">
         <div v-for="item in link.children" :key="item.label">
           <NavItem :item="item"/>
         </div>
       </div>
